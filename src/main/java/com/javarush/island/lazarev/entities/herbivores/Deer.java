...
public class Deer extends Animal {
    ...
    public Deer(TileIcon tileIcon, double weight, double probabilityToBeEaten, FoodType foodType, int moveSpeed, double foodNeeded, double probabilityToFindFood) {
