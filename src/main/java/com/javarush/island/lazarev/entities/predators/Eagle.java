...
public class Eagle extends Animal {
    ...
    public Eagle(TileIcon tileIcon, double weight, double probabilityToBeEaten, FoodType foodType,
                 int moveSpeed, double foodNeeded, double probabilityToFindFood) {
